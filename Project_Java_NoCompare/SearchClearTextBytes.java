...
public class SearchClearTextBytes {
    ...
    public SearchClearTextBytes(int alg_index, String targetStr, int strLen, int threadMax, int mode, boolean arg_enableMultiThread, boolean enableDebug) {
    ...
    public String Get_ClearText(int threadMax) {
        ...
        // 平文が""かどうかを判定する。
        //-------------------------------------------------------------------------//
        computeHash.ComputeHash_Common(Algorithm_Index, "".getBytes());
        /*
